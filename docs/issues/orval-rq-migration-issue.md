...
- [ ] Orval 및 TanStack Query 의존성 추가
- [ ] Custom Fetcher 구현 (`orvalFetcher.ts`)
- [ ] QueryClientProvider 및 Hydration 설정
- [ ] Orval 코드 생성

### Phase 2: 기능별 마이그레이션

- [ ] Posts 읽기 Hydration 적용
- [ ] Posts Mutation 마이그레이션
- [ ] Likes Mutation 마이그레이션 (Optimistic UX)
- [ ] Comments 마이그레이션
- [ ] User/Profile 마이그레이션
- [ ] Admin 기능 마이그레이션
- [ ] Chatbot 마이그레이션
...
- [ ] 기존 OpenAPI Generator 코드 제거 (`src/generated/api/`)
- [ ] 레거시 훅 정리
- [ ] 문서 업데이트 (CLAUDE.md, README.md)

### 검증

- [ ] 기존 기능이 정상 동작하는지 확인 (Regression Test)
- [ ] 빌드 성공 확인
