  ...
  return (
    <div
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="mb-4">
          <div className="mb-4 text-center text-sm text-gray-500">오늘 4:05</div>
          ...
          <div className="mb-4 flex items-start gap-3">
            ...
            <div className="max-w-[400px] rounded-lg bg-gray-100 px-4 py-2 font-medium">
              ...
              <div className="text-gray-900">감자 챗봇에 오신걸 환영합니다.</div>
            </div>
          </div>

          {/* 사용자 메시지 */}
          <div className="mb-4 flex justify-end font-medium">
            <div className="max-w-[400px] rounded-lg bg-black px-4 py-2 text-white">
              감기블 대박이다~
            </div>
          </div>
        </div>
