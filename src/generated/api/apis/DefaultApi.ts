...
import {
    ...
    ResponseDtoAccessTokenResponseFromJSON,
    ResponseDtoAccessTokenResponseToJSON,
    ResponseDtoBooleanFromJSON,
    ...
    ResponseDtoListCommitHistoryResponseToJSON,
    ResponseDtoListPendingUserResponseFromJSON,
    ResponseDtoListPendingUserResponseToJSON,
    ResponseDtoListPostPopularResponseFromJSON,
    ResponseDtoListPostPopularResponseToJSON,
    ResponseDtoListProjectListResponseFromJSON,
    ...
    ResponseDtoPagedResponsePostListResponseToJSON,
    ResponseDtoPostDetailResponseFromJSON,
    ResponseDtoPostDetailResponseToJSON,
    ResponseDtoPostResponseFromJSON,
    ResponseDtoPostResponseToJSON,
    ResponseDtoProfileImageResponseFromJSON,
    ResponseDtoProfileImageResponseToJSON,
    ResponseDtoProjectListResponseFromJSON,
    ResponseDtoProjectListResponseToJSON,
    ResponseDtoStringFromJSON,
    ResponseDtoStringToJSON,
    ResponseDtoUserActivityResponseFromJSON,
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * 게시물에 댓글 등록
     */
    async addCommentRaw(requestParameters: AddCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoCommentResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoCommentResponseFromJSON(jsonValue));
    }

    /**
     * 게시물에 댓글 등록
     */
    async addComment(requestParameters: AddCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoCommentResponse> {
     ...
     */
    async approveUserProfileRaw(requestParameters: ApproveUserProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoVoid>> {
    ...
    async completeProfileRaw(requestParameters: CompleteProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoUserProfileResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoUserProfileResponseFromJSON(jsonValue));
    }
    ...
    async createProjectRaw(requestParameters: CreateProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoProjectListResponse>> {
        ...
        if (requestParameters['request'] != null) {
            formParams.append('request', new Blob([JSON.stringify(ResponseDtoProjectListResponseToJSON(requestParameters['request']))], { type: "application/json", }));
                    }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoProjectListResponseFromJSON(jsonValue));
    }

    /**
     * 프로젝트 생성
     */
    async createProject(requestParameters: CreateProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoProjectListResponse> {
     ...
     * 댓글 삭제
     */
    async deleteCommentRaw(requestParameters: DeleteCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoStringFromJSON(jsonValue));
    }
     ...
     * 프로필 사진 삭제
     */
    async deleteProfileImageRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoVoid>> {
        const queryParameters: any = {};
     ...
     * 프로필 사진 삭제
     */
    async deleteProfileImage(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoVoid> {
     ...
     * 프로젝트 삭제
     */
    async deleteProjectRaw(requestParameters: DeleteProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
     ...
     * 프로젝트 삭제
     */
    async deleteProject(requestParameters: DeleteProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoString> {
     ...
     */
    async getActivitySummaryRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoUserActivityResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoUserActivityResponseFromJSON(jsonValue));
    }
     ...
     * 전체 프로젝트 목록 조회
     */
    async getAllProjectsRaw(requestParameters: GetAllProjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoListProjectListResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoListProjectListResponseFromJSON(jsonValue));
    }

    /**
     * 전체 프로젝트 목록 조회
     */
    async getAllProjects(requestParameters: GetAllProjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoListProjectListResponse> {
     ...
     * 전체 태그 조회
     */
    async getAllTagsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoListString>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoListStringFromJSON(jsonValue));
    }
     ...
     * 전체 태그 조회
     */
    async getAllTags(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoListString> {
     ...
     * 게시물의 댓글 목록 조회
     */
    async getCommentsRaw(requestParameters: GetCommentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoListCommentResponse>> {
        if (requestParameters['postId'] == null) {
            throw new runtime.RequiredError(
                'postId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoListCommentResponseFromJSON(jsonValue));
    }

    /**
     * 게시물의 댓글 목록 조회
     */
    async getComments(requestParameters: GetCommentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoListCommentResponse> {
     ...
     * 게시물 커밋 내역
     */
    async getCommitHistoriesRaw(requestParameters: GetCommitHistoriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoListCommitHistoryResponse>> {
        if (requestParameters['postId'] == null) {
            throw new runtime.RequiredError(
                'postId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoListCommitHistoryResponseFromJSON(jsonValue));
    }

    /**
     * 게시물 커밋 내역
     */
    async getCommitHistories(requestParameters: GetCommitHistoriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoListCommitHistoryResponse> {
     ...
     * 정보 조회
     */
    async getCurrentUserProfileRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoUserProfileResponse>> {
        const queryParameters: any = {};
     ...
     * 정보 조회
     */
    async getCurrentUserProfile(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoUserProfileResponse> {
     ...
     * 역할 조회
     */
    async getCurrentUserRoleRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
        const queryParameters: any = {};
     ...
     * 내가 단 댓글 목록 조회
     */
    async getMyCommentsRaw(requestParameters: GetMyCommentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPagedResponseCommentListResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoPagedResponseCommentListResponseFromJSON(jsonValue));
    }

    /**
     * 내가 단 댓글 목록 조회
     */
    async getMyComments(requestParameters: GetMyCommentsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPagedResponseCommentListResponse> {
     ...
     * 내가 누른 좋아요 목록 조회
     */
    async getMyLikesRaw(requestParameters: GetMyLikesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPagedResponseLikeResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoPagedResponseLikeResponseFromJSON(jsonValue));
    }

    /**
     * 내가 누른 좋아요 목록 조회
     */
    async getMyLikes(requestParameters: GetMyLikesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPagedResponseLikeResponse> {
     ...
     * 내가 쓴 게시물 목록 조회
     */
    async getMyPostsRaw(requestParameters: GetMyPostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPagedResponsePostListResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoPagedResponsePostListResponseFromJSON(jsonValue));
    }

    /**
     * 내가 쓴 게시물 목록 조회
     */
    async getMyPosts(requestParameters: GetMyPostsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPagedResponsePostListResponse> {
     ...
     */
    async getPendingUsersRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoListPendingUserResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoListPendingUserResponseFromJSON(jsonValue));
    }

    /**
     * 대기 중인(PENDING) 사용자 전체 조회
     */
    async getPendingUsers(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoListPendingUserResponse> {
     ...
     * 단일 게시물 상세 조회
     */
    async getPostDetailRaw(requestParameters: GetPostDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPostDetailResponse>> {
        if (requestParameters['postId'] == null) {
            throw new runtime.RequiredError(
                'postId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoPostDetailResponseFromJSON(jsonValue));
    }

    /**
     * 단일 게시물 상세 조회
     */
    async getPostDetail(requestParameters: GetPostDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPostDetailResponse> {
     ...
     * 태그별 게시물 조회
     */
    async getPostsByTagRaw(requestParameters: GetPostsByTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPagedResponsePostListResponse>> {
        ...
        urlPath = urlPath.replace(`{${"tagName"}}`, encodeURIComponent(String(requestParameters['tagName'])));
     ...
     * 태그별 게시물 조회
     */
    async getPostsByTag(requestParameters: GetPostsByTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPagedResponsePostListResponse> {
     ...
     * 프로필 사진 확인
     */
    async getProfileImageRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoProfileImageResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoProfileImageResponseFromJSON(jsonValue));
    }
     ...
     * 주간 인기 게시물 조회
     */
    async getWeeklyPopularPostsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoListPostPopularResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoListPostPopularResponseFromJSON(jsonValue));
    }

    /**
     * 주간 인기 게시물 조회
     */
    async getWeeklyPopularPosts(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoListPostPopularResponse> {
     ...
     */
    async isPostLikedRaw(requestParameters: IsPostLikedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoBoolean>> {
        if (requestParameters['postId'] == null) {
            throw new runtime.RequiredError(
                'postId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoBooleanFromJSON(jsonValue));
    }

    /**
     * 내가 해당 게시글에 좋아요 눌렀는지 여부 조회
     */
    async isPostLiked(requestParameters: IsPostLikedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoBoolean> {
     ...
     * 게시글 좋아요
     */
    async likePostRaw(requestParameters: LikePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
        if (requestParameters['postId'] == null) {
            throw new runtime.RequiredError(
                'postId',
     ...
     * 게시글 좋아요
     */
    async likePost(requestParameters: LikePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoString> {
     ...
     * 로그아웃
     */
    async logoutRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
        const queryParameters: any = {};
     ...
     * 게시물 작성
     */
    async publishPostRaw(requestParameters: PublishPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPostResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoPostResponseFromJSON(jsonValue));
    }

    /**
     * 게시물 작성
     */
    async publishPost(requestParameters: PublishPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPostResponse> {
     ...
     * 토큰 재발급
     */
    async reissueRaw(requestParameters: ReissueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoAccessTokenResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseDtoAccessTokenResponseFromJSON(jsonValue));
    }

    /**
     * 토큰 재발급
     */
    async reissue(requestParameters: ReissueRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoAccessTokenResponse> {
     ...
     * 게시물 삭제
     */
    async removePostRaw(requestParameters: RemovePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoVoid>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * 게시물 삭제
     */
    async removePost(requestParameters: RemovePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoVoid> {
        const response = await this.removePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * 게시물 수정
     */
    async revisePostRaw(requestParameters: RevisePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPostResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * 게시물 수정
     */
    async revisePost(requestParameters: RevisePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPostResponse> {
     ...
     * 게시물 검색
     */
    async searchPostsRaw(requestParameters: SearchPostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoPagedResponsePostListResponse>> {
        if (requestParameters['pageable'] == null) {
            throw new runtime.RequiredError(
                'pageable',
     ...
     * 게시물 검색
     */
    async searchPosts(requestParameters: SearchPostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoPagedResponsePostListResponse> {
     ...
     * 좋아요 취소
     */
    async unlikePostRaw(requestParameters: UnlikePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
        if (requestParameters['postId'] == null) {
            throw new runtime.RequiredError(
                'postId',
     ...
     * 정보 업데이트(마이페이지용)
     */
    async updateProfileRaw(requestParameters: UpdateProfileOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoUserProfileResponse>> {
     ...
     * 정보 업데이트(마이페이지용)
     */
    async updateProfile(requestParameters: UpdateProfileOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoUserProfileResponse> {
     ...
     * 프로필 사진 업로드/수정
     */
    async updateProfileImage(requestParameters: UpdateProfileImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoProfileImageResponse> {
     ...
     * 프로젝트 수정
     */
    async updateProjectRaw(requestParameters: UpdateProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoProjectListResponse>> {
        if (requestParameters['projectId'] == null) {
            throw new runtime.RequiredError(
                'projectId',
     ...
     * 프로젝트 수정
     */
    async updateProject(requestParameters: UpdateProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoProjectListResponse> {
     ...
     * 게시글 이미지 업로드
     */
    async uploadImageRaw(requestParameters: UploadImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
     ...
     * 게시글 이미지 업로드
     */
    async uploadImage(requestParameters: UploadImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoString> {
     ...
     * 계정 삭제
     */
    async withdrawRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseDtoString>> {
        const queryParameters: any = {};
     ...
     * 계정 삭제
     */
    async withdraw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseDtoString> {
